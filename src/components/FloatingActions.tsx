    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 flex md:hidden">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex min-h-14 flex-1 items-center justify-center gap-1.5 bg-[#25D366] pb-[env(safe-area-inset-bottom)] text-xs font-semibold text-white"
        >
          <svg viewBox="0 0 32 32" className="h-4 w-4" fill="#FFFFFF" aria-hidden="true">
            <path d={whatsappIconPath} />
          </svg>
          WhatsApp
        </a>
        <button
          ...
          className="flex min-h-14 flex-1 items-center justify-center gap-1.5 bg-charcoal-light pb-[env(safe-area-inset-bottom)] text-xs font-semibold text-bronze"
        >
        ...
        <a
          href={CALL_LINK}
          className="flex min-h-14 flex-1 items-center justify-center gap-1.5 bg-bronze pb-[env(safe-area-inset-bottom)] text-xs font-semibold text-charcoal"
        >
          <Phone className="h-4 w-4" strokeWidth={1.75} fill="currentColor" />
          Call
        </a>
      </div>
    </>
